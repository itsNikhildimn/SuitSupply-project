! function(t) {
    ...
    */
    ...
    function z(t) {
        ...
        $(".pdp-usp").length && (e -= Number($(".pdp-usp").css("margin-top").slice(0, -2)) + Number($(".pdp-usp").css("margin-bottom").slice(0, -2)) + 20), f.style.setProperty("--mobile-info-visible", "".concat(157, "px")), l()(t) && setTimeout(t, 400)
    }
